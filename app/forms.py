...
from django.contrib.auth.forms import UserCreationForm ,PasswordResetForm, AuthenticationForm  , UsernameField , PasswordChangeForm ,SetPasswordForm
...
class UserChangedPasswordForm(PasswordChangeForm):
...
class MyProfileViewForm(forms.ModelForm):
   class Meta:
      model=Customer
